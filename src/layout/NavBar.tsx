...
import { SearchOutlined, DownOutlined, BorderInnerOutlined, BellFilled, QuestionCircleFilled, SettingFilled } from '@ant-design/icons';
import { navBarList } from './ItemsLists';
...
const NavBar: React.FC = () => {
  ...
  const content = (
    <Layout.Header className='header' >
      ...
      <div className="header-child">
        <Menu mode="horizontal" items={[
          ...
          },
          {
            ...
            label: <>
              {!addingTask && (<Button key="button" type="primary" onClick={handleAddTask}> Create </Button>)}
              {addingTask && (
                <form onSubmit={handleNewTaskContainer}>
                  <input type="text" value={newTaskContainerName} onChange={handleNewTaskContainerNameChange} />
      ...
      <div className="header-child">
        <Input placeholder="Search" title='Search / ' prefix={<SearchOutlined style={{ color: '#aaa' }} />} style={{ width: '200px', height: '32px' }} />
        <BellFilled title='Notifications' />
        <QuestionCircleFilled title='Help' />
        <SettingFilled title='Settings' />
        <img src="https://secure.gravatar.com/avatar/4139e1d0136c2421ad5a5bece95f2d7d?d=https%3A%2F%2Favatar-management--avatars.us-west-2.prod.public.atl-paas.net%2Finitials%2FTA-4.png" alt="Profile image of Taj Al Den Ajek" style={{ borderRadius: "50%", width: '24px' }} />
      </div>
    </Layout.Header >
  )
  return content;
